...
Item {
    ...
    GroupBox {
        ...
        SwitchDelegate {
            ...
            x: 167
            y: -79
            text: qsTr("Luces Switch 1 2 Focos Iluminación")
            z: 3
        }
        ...
        SwitchDelegate {
            ...
            x: -181
            y: -79
            text: "Tomacorrientes Persianas Puerta"
            z: 3
        }
